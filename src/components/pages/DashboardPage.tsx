      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { icon: <TrendingDown className="h-5 w-5" />, label: 'Weight', value: `${store.weight}kg`, sub: `BMI: ${bmi}`, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
              initial={{ opacity: 0, y: 20 }}
                      ...
                      >
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="min-w-0">
                            ...
                            <Badge variant="secondary" className="mt-1">{levelLabels[store.level] || store.level}</Badge>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="p-3 rounded-xl bg-muted/50 text-center">
                            ...
                            <p className="text-sm font-semibold">{store.weight}kg</p>
                            <p className="text-xs text-muted-foreground">Weight</p>
                          </div>
                          <div className="p-3 rounded-xl bg-muted/50 text-center">
                            <Ruler className="h-4 w-4 mx-auto mb-1 text-primary" />
                            <p className="text-sm font-semibold">{store.height}cm</p>
                            <p className="text-xs text-muted-foreground">Height</p>
                          </div>
                          <div className="p-3 rounded-xl bg-muted/50 text-center">
                            <Target className="h-4 w-4 mx-auto mb-1 text-primary" />
                            <p className="text-sm font-semibold">{goalLabels[store.goal] || store.goal}</p>
